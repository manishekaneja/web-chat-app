// OnBoardingScreen.import { FC, Fragment } from "react";
...
const OnBoardingScreen: FC<NoProps> = () => {
  ...
  return (
    <div className=" w-full h-full teal-green flex flex-col items-stretch justify-center ">
      <div
        className="flex flex-col items-stretch justify-center p-10"
      >
        ...
        <div className="flex-0">
          ...
          <button className="bg-white shadow p-2 my-10 w-full" onClick={googleLogin} >
